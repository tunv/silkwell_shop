              ...
              <tbody>
                  <?php foreach ($products as $product): ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url()?>admin/product/delete/<?=$product->product_id?>" class="btn btn-danger " onclick="return confirm('Apakah Anda yakin ingin menghapus?')"> <i class="fa fa-trash-o" > </i>
